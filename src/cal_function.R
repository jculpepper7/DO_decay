...
cal_1 <- cal_raw[[1]] #Will exclude from sample as it is only 2 hours. I do not have notes on this, but I suspect it may be a calibration.
...
cal_cleaned <- bind_rows(cal_2, cal_3, cal_4, cal_5, cal_6, cal_7, cal_8, cal_9, cal_10,
...
write_csv(cal_cleaned, here('data/processed/castle/castle_clean_agg_data.csv'))
