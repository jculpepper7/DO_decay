...
write_csv(cal_03m_all_raw, here('data/castle/cal_03m_20_21_raw.csv'))
...
cal_03m_plt <- ggplot()+
  ...
  ggtitle('Castle 3m DO & Temperature')+
  theme(text = element_text(size = 20))

ggsave(filename = "cal_03m_20_21_plt.png", path = here('output/plots'), dpi = 500)
...
#aggregate 30 m data
cal_1 <- read_delim(here('data/castle/cal_30m_miniDOT_2020.05.09_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
cal_2 <- read_delim(here('data/castle/cal_30m_miniDOT_2020.06.17_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
cal_3 <- read_delim(here('data/castle/cal_30m_miniDOT_2020.06.30_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
# cal_4 <- read_delim(here('data/castle/cal_30m_miniDOT_2020.07.16_raw.txt'), delim = ',', skip = 7) %>%
#   clean_names() %>%#clean names from miniDOT software default
#   slice(-c(1)) %>%
#   select(1,2,3,5,6,7) %>%
#   rename(
...
#---------------------------------
cal_5 <- read_delim(here('data/castle/cal_30m_miniDOT_2020.08.12_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
cal_6 <- read_delim(here('data/castle/cal_30m_miniDOT_2020.09.22_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
cal_7 <- read_delim(here('data/castle/cal_30m_miniDOT_2020.10.14_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
cal_8 <- read_delim(here('data/castle/cal_30m_miniDOT_2021.05.16_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
cal_9 <- read_delim(here('data/castle/cal_30m_miniDOT_2021.06.11_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
cal_10 <- read_delim(here('data/castle/cal_30m_miniDOT_2021.06.29_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
cal_11 <- read_delim(here('data/castle/cal_30m_miniDOT_2021.07.19_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
###Note: time zone was central standard time. had to convert to pst. see line 267
cal_12 <- read_delim(here('data/castle/cal_30m_miniDOT_2021.08.05_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
cal_13 <- read_delim(here('data/castle/cal_30m_miniDOT_2021.08.17_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
cal_14 <- read_delim(here('data/castle/cal_30m_miniDOT_2021.09.11_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#---------------------------------
cal_15 <- read_delim(here('data/castle/cal_30m_miniDOT_2021.10.15_raw.txt'), delim = ',', skip = 7) %>%
  clean_names() %>%#clean names from miniDOT software default
  slice(-c(1)) %>%
  select(1,2,3,5,6,7) %>%
  rename(
...
#aggregate raw data from 30 meters
cal_30m_all_raw <- bind_rows(cal_1, cal_2, cal_3, cal_5,cal_6, cal_7, cal_8, cal_9, cal_10, cal_11, cal_12, cal_13, cal_14, cal_15)

write_csv(cal_30m_all_raw, here('data/castle/cal_30m_20_21_raw.csv'))

#initial plao for cal 30 meter data
cal_30m_plt <- ggplot()+
  geom_line(data = cal_30m_all_raw, aes(x = pst, y = temp_c), color = 'grey')+
  geom_line(data = cal_30m_all_raw, aes(x = pst, y = do_mg_l), color = 'black')+
  theme_classic()+
  xlab('Date')+
  ylab('Temperature [C] / DO [mg/L]')+
  ggtitle('Castle 30m DO & Temperature')+
  ylim(c(0,12))+
  theme(text = element_text(size = 20))
